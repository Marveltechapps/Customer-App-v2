...
export type RootStackParamList = {
  ...
  Login: {
    ...
    phone?: string;
    countryCode?: string;
    /** Resume this screen after a successful login (auth-gated entry points). */
    returnTo?: 'Settings';
  } | undefined;
  OTPVerification: {
    phoneNumber: string;
  ...
  LocationPermission: { fromAuth?: boolean; returnTo?: 'Settings' } | undefined;
  MainTabs: {
  ...
  Payment: {
    ...
    appliedCoupon?: { code: string; discount: number };
    addressId?: string;
    /** Existing unpaid order — resume / retry payment */
    orderId?: string;
    ...
    initialPaymentMethod?: 'cash' | 'digital' | 'card' | 'upi' | 'wallet' | 'selorg_wallet';
...
export type OrdersStackParamList = {
  ...
  OrderItemsDetails: {
    ...
    paymentMethodLines?: Array<{ label: string; amount?: number | null }>;
